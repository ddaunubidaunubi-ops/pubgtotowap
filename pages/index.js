...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>PUBGTOTO ~ Login Resmi Anti Lelet | Bertahan Hidup di Medan Gacor</title>
        <meta name="description" content="PUBGTOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="PUBGTOTO ~ Login Resmi Anti Lelet | Bertahan Hidup di Medan Gacor" />
        <meta property="og:description" content="PUBGTOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="PUBGTOTO ~ Login Resmi Anti Lelet | Bertahan Hidup di Medan Gacor" />
        <meta name="twitter:description" content="PUBGTOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
      ...
      <style jsx global>{`
        :root{--bg:#05050f;--bg2:#0a0a1a;--card:#12122a;--primary:#00ff88;--primary2:#00cc6a;--accent:#00e5ff;--text:#e0ffe8;--muted:#6ee7a0;--border:rgba(0,255,136,.08);--r:4px}
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        ...
        header{position:sticky;top:0;z-index:50;background:#05050fe8;backdrop-filter:blur(14px);border-bottom:1px solid var(--border)}
        ...
        .bp{background:var(--primary);color:#05050f;box-shadow:0 4px 16px #00ff8835}
        .bp:hover{background:var(--primary2);transform:translateY(-2px);box-shadow:0 6px 24px #00ff8850}
        ...
        .badge{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;border:1px solid var(--border);border-radius:99px;font-size:12px;color:var(--primary);background:#00ff8810;margin-bottom:20px;font-weight:600}
        ...
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px #00ff8820}
        ...
        .sh .tg{display:inline-block;padding:5px 14px;border:1px solid var(--border);border-radius:var(--r);font-size:11px;color:var(--primary);background:#00ff8808;margin-bottom:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px}
        ...
        .fc:hover{transform:translateY(-4px);border-color:var(--primary);box-shadow:0 10px 30px #00ff8815}
        .fc .ic{width:48px;height:48px;border-radius:var(--r);background:#00ff8812;display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:12px}
        ...
        .step .nm{width:46px;height:46px;border-radius:50%;background:var(--primary);color:#05050f;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:16px;margin:0 auto 10px}
        ...
        .cta{background:var(--primary);border-radius:var(--r);padding:48px 28px;text-align:center;color:#05050f}
        ...
        .hero{background:linear-gradient(180deg,#05050f,#0a0a1a);position:relative}.hero::before{content:'';position:absolute;inset:0;background:repeating-linear-gradient(0deg,transparent,transparent 2px,rgba(0,255,136,.02) 2px,rgba(0,255,136,.02) 4px)}.bp{background:#00ff88;color:#05050f;text-transform:uppercase;letter-spacing:2px;clip-path:polygon(8px 0,100% 0,calc(100% - 8px) 100%,0 100%)}.fc{clip-path:polygon(0 0,calc(100% - 12px) 0,100% 12px,100% 100%,12px 100%,0 calc(100% - 12px))}
      `}</style>
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>PUBGTOTO ~ Login Resmi Anti Lelet | Bertahan Hidup di Medan Gacor</h1>
        ...
        <section className="sec" id="tentang"><div className="C">
          ...
          <div className="art">
            <p>PUBGTOTO di situs resmi PUBGTOTO adalah arena digital ultimate dengan performa yang tidak tertandingi. Layaknya game dengan grafis terbaik, platform PUBGTOTO menghadirkan pengalaman akses yang smooth dan immersive. Server berperforma tinggi memastikan zero lag, sementara sistem keamanan berlapis menjadi shield yang melindungi setiap data dan akun pengguna.</p>
            <p>Level up pengalaman digital Anda bersama PUBGTOTO melalui situs resmi PUBGTOTO. Dengan power-up berupa enkripsi SSL 256-bit, uptime 99,9%, dan multiple link alternatif aktif, Anda siap menaklukkan setiap tantangan akses. Tim support 24/7 adalah party member yang selalu siap membantu, memastikan quest Anda menuju platform PUBGTOTO selalu berhasil dengan perfect score.</p>
          </div>
        </div></section>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1542751371-adc38448a05e?w=720&h=280&fit=crop" alt="PUBGTOTO - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=720&h=280&fit=crop" alt="PUBGTOTO - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1593305841991-05c297ba4575?w=720&h=280&fit=crop" alt="PUBGTOTO - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
